...
import {
  UserAccountStatus,
} from './enums/user-account-status.enum';
...
export class UsersService {
  ...
  // ===========================================================================
  // MEMBRES D'ÉQUIPAGE ACTIFS ET APPROUVÉS
  // ===========================================================================
  ...
  // ===========================================================================
  // RECHERCHE PAR EMAIL AVEC MOT DE PASSE
  // ===========================================================================
   ...
   * jamais d'Admin ni de Product Owner
   * et toujours PENDING.
   */
  async create(
    dto:
  ...
  async setPending(
    ...
    return {
      message:
        'Compte remis en attente de validation.',
