...
export const DashboardGantt: React.FC = () => {
  ...
  const statusStyles = useMemo<Record<FlightStatus, StatusStyle>>(
    () => ({
      Scheduled: {
        label: 'Planifié',
        dot: 'bg-emerald-500',
          ...
          <div className="flex flex-col gap-3 px-4 py-3.5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
              <button
                ...
                disabled={isFetching}
                className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 text-[11px] font-semibold text-slate-600 transition hover:bg-slate-50 hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <RefreshCw
              ...
              <button
                ...
                className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg border border-emerald-200 bg-emerald-50 px-3 text-[11px] font-semibold text-emerald-700 transition hover:bg-emerald-100 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <Cpu
                  className={`h-3.5 w-3.5 ${
              ...
              <button
                ...
                disabled={isCreating}
                className="col-span-2 inline-flex h-9 items-center justify-center gap-1.5 rounded-lg bg-emerald-700 px-3.5 text-[11px] font-semibold text-white transition hover:bg-emerald-800 disabled:cursor-not-allowed disabled:opacity-50 sm:col-span-1"
              >
        ...
        {globalError && (
          <div className="flex items-start gap-2.5 rounded-lg border border-rose-200 bg-rose-50 px-3.5 py-3">
            ...
            <button
              ...
              className="flex h-6 w-6 items-center justify-center rounded-md text-rose-500 hover:bg-rose-100"
            >
        ...
        {globalSuccess && (
          <div className="flex items-start gap-2.5 rounded-lg border border-emerald-200 bg-emerald-50 px-3.5 py-3">
            ...
            <button
              ...
              className="flex h-6 w-6 items-center justify-center rounded-md text-emerald-600 hover:bg-emerald-100"
            >
              <X className="h-3.5 w-3.5" />
            </button>
          </div>
